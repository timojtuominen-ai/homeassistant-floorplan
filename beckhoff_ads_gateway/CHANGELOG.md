...
- Fixed startup crash with paho-mqtt 2.x / Python 3.14.
- MQTT `on_connect` now handles the `ReasonCode` object correctly.
- No ADS read logic or PLC-facing behavior changed.
